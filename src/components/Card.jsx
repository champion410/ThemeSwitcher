...
export default function Card() {
    ...
    <stop offset="1" stop-color="#5AD010"/>
                    ...
                    <span className="text-3sm font-bold text-gray-900 dark:text-white ml-1">
                    Location: Milano</span>
                </div>
